...
fn has_explicit_align_self(spec: &SolverSpec) -> bool {
    matches!(
        spec.align_self_ext,
        Some(
            UAlignSelfExt::Start
...
fn has_explicit_justify_self(spec: &SolverSpec) -> bool {
    matches!(
...
mod tests {
    ...
    fn nowrap_single_line_align_items_center_centers_in_container_cross_axis() {
        ...
        // Free cross space = 100 - 20 = 80 => centered at y = 40.
    ...
    fn grid_auto_flow_row_is_sparse_no_backfill() {
        ...
        // Sparse row auto-placement should keep the row-2 hole and continue from the cursor.
